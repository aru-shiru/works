...
**Lamacca public cards:** product **Crowdfunding** (Wakafyuk.id + Bantusesama.id) and work **Wakafyuk & Bantusesama (2020)**. Git is **2020–21** (Wakafyuk), **2022–24** (Bantu), **2023–24** (WBN). **WBN is not named** on `/products`. Not on GitHub Selected Projects. **No MAU** — do not invent.
...
| Lamacca “2023” | Old marketing flatten. Site year is **2020** (first Wakafyuk commit). |
