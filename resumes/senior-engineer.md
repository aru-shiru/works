...
**Languages:** TypeScript, Dart, PHP, Go, SQL, Swift, Kotlin
**Backend:** NestJS, Laravel, Node.js, PostgreSQL, Redis, SuperTokens, Elasticsearch, Meilisearch, BullMQ, REST, OpenAPI
**Frontend:** React, Next.js, Vue, Nuxt, Livewire, Inertia, TanStack, Tailwind CSS
**Mobile:** Flutter, Expo, React Native
**Cloud:** AWS (RDS, S3, ECS), GCP (Cloud Run, Cloud SQL), Firebase, Docker, Terraform, Cloudflare, Fly.io
**Practices:** system design, multi-tenant SaaS, RBAC, data migration, technical leadership, code review
...
**ADVLive — Advansia Indonesia and Malaysia | Tech lead (2 engineers) | Indonesia since 2021; rewrite Oct 2025 – Present**
- Indonesia still live on Firestore / Next / Expo (GitHub: 50K+ sales records, ~100K field activities on that predecessor). Leading two engineers on a Nest + Nuxt + Expo + Postgres rewrite so Indonesia and Malaysia share one codebase.
...
- Led two engineers. Clone-per-dinas Laravel/Inertia + Expo on Fly.io for three transport agencies (Sulsel, Paser, Samarinda). White-label by git clone, not one shared database.

**Additional projects:** Led two engineers on e-Hibah (Polri grants; v1 on Fly.io, later sole Livewire rewrite). Led three on North Kalimantan Laravel systems (assets, pricing, liaison office). Led four on Wakaf Bangun Negeri (donations); wrote Flutter on Wakafyuk and Bantu Sesama. Led two native engineers on Narrative Phone (xCareField, Japan), then finished Swift and Kotlin after they left. e-Watch for LSI (sole; Flutter field app + Nuxt HQ). KAHMI alumni app (led web; wrote Flutter).

**Co-Founder and Full-Stack Engineer**
Belliki — Indonesia | 2016 – 2018

Apparel marketplace with an in-browser designer and vendor fulfillment. Vue.js, Node.js, Fabric.js.

## Education

**Associate Degree, Information Processing** — Seifu Institute of Technology, Osaka
Graduation project (voice-recognition scheduler for Windows) recognised as outstanding by a Microsoft Japan representative.
