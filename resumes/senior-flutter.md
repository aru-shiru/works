...
**Senior Flutter Engineer** | Mobile Technical Lead
...
**Flutter / Dart:** Riverpod, go_router, Provider, SQLite, Geolocator, camera, Firebase (Auth, Firestore, Storage, FCM), custom tokens, offline queues, white-label Android IDs, Play Store
**Other mobile:** Expo, React Native, Swift, Kotlin
**APIs:** NestJS, Laravel, Cloud Functions, PostgreSQL, Elasticsearch
...
**simPAN — Partai Amanat Nasional | Sole engineer (mobile) | 2021 – Present**
...
**Additional projects:** Geo-fenced staff attendance for a provincial library and archives office. Facility-management companion app for Prima Nusantara. Field apps for SDS and Advansia (Expo; Advansia rewrite with two engineers, Oct 2025). Led two native engineers on Narrative Phone for xCareField Japan (Swift, Kotlin, Zoom / CallKit), then finished both platforms.

**Co-Founder**
Belliki — Indonesia | 2016 – 2018

Apparel marketplace. Vue, Node, Fabric.js.
